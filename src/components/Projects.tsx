  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        {research && (
          <article
            className="glass-card reveal group flex flex-col overflow-hidden"
            data-reveal="left"
            data-reveal-delay="0"
          >
            {/* Image area */}
            <div className="relative overflow-hidden bg-slate-200 dark:bg-slate-800/60">
              <img
                src={research.image}
                alt={research.title}
                className="h-56 w-full object-cover object-top transition-transform duration-700 group-hover:scale-[1.06] sm:h-64"
              />
              {/* Dual status badges */}
