    ...
    >
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {certifications.map((cert, i) => {
          ...
          return (
            <div key={cert.title} className="glass-card reveal group p-6" data-reveal-delay={String(i * 90)}>
              <div className="flex items-start gap-4">
                <span className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl border border-sky-500/30 bg-gradient-to-br from-sky-500/15 to-cyan-500/10 text-sky-600 transition-all duration-300 group-hover:scale-105 dark:border-accent-500/30 dark:from-accent-500/15 dark:to-cyan-glow/10 dark:text-accent-400">
